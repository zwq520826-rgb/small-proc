...
const _sfc_main = {
  ...
  methods: {
    ...
    setUserInfo(e) {
      common_vendor.index.__f__("log", "at uni_modules/uni-id-pages/components/uni-id-pages-fab-login/uni-id-pages-fab-login.vue:195", "setUserInfo", e);
    },
    getRoute(n = 0) {
    ...
    toPage(path, index = 0) {
      if (this.getRoute(1) == path.split("?")[0] && this.getRoute(1) == "/uni_modules/uni-id-pages/pages/login/login-withoutpwd") {
        ...
        common_vendor.index.__f__("log", "at uni_modules/uni-id-pages/components/uni-id-pages-fab-login/uni-id-pages-fab-login.vue:232", "出乎意料的情况,path：" + path);
      }
    },
    async login_before(type, navigateBack = true, options = {}) {
      var _a, _b;
      common_vendor.index.__f__("log", "at uni_modules/uni-id-pages/components/uni-id-pages-fab-login/uni-id-pages-fab-login.vue:236", type);
      if ([
        "qq",
        "xiaomi",
        "sinaweibo",
      ...
      if (type == "univerify") {
        ...
        let onButtonsClickFn = async (res) => {
          common_vendor.index.__f__("log", "at uni_modules/uni-id-pages/components/uni-id-pages-fab-login/uni-id-pages-fab-login.vue:354", "点击了第三方登录，provider：", res, res.provider, this.univerifyStyle.buttons.list);
        ...
        return univerifyManager.login({
          ...
          fail(err) {
            common_vendor.index.__f__("log", "at uni_modules/uni-id-pages/components/uni-id-pages-fab-login/uni-id-pages-fab-login.vue:404", err);
      ...
      common_vendor.index.login({
        ...
        fail: async (err) => {
          common_vendor.index.__f__("log", "at uni_modules/uni-id-pages/components/uni-id-pages-fab-login/uni-id-pages-fab-login.vue:449", err);
          common_vendor.index.hideLoading();
        }
      });
    },
